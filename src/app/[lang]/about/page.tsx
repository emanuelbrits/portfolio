            ...
            <div className='flex flex-col mt-32'>
                ...
                <div className='flex flex-col md:flex-row w-full mt-12'>
                    <div className='flex flex-col w-full md:w-1/2 lg:w-1/3 md:pr-2'>
                        <h4 className='text-2xl md:text-3xl xl:text-5xl font-bold'>{dictionary.myStack}.</h4>
                        <div className='flex items-center h-64 md:h-80 bg-neutral-400 rounded-3xl mt-4 shadow-4xl'>
                    ...
                    <div className='flex flex-col w-full md:w-1/2 lg:w-2/3 mt-12 md:mt-0 md:pl-2'>
                        <h4 className='text-2xl md:text-3xl xl:text-5xl font-bold mb-4'>{dictionary.whereIAm}.</h4>
                        <GlobeComponent />
                    </div>
                </div>
            </div>
